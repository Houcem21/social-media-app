  ...
  return (
    <Form {...form}>
      ...
      <div className="sm:w-420 flex-center flex-col">
        ...
        <h2 className="h3-bold md:h2-bold pt-5 sm:pt-12">Register as new user</h2>
        <p className="text-light-3 small-medium md:base-regular mt-2">Enter your info below</p>
